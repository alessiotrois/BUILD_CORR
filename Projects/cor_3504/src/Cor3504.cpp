...
int Open3504(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3504......... starting  #########\n");
	fprintf(fp, "Cor3504..................... starting Open3504\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3504......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3504..................... starting Open3504\n");
	...
	if ( status) {
		fprintf(fp, "Cor3504..................... exiting Open3504 ERROR: %d", status);
		printf("Cor3504..................... exiting Open3504 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3504..................... exiting Open3504 STATUS = 0\n\n");
		printf("Cor3504..................... exiting Open3504 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3504..................... exiting CorrTime ERROR:");
		printf("Cor3504..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3504..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3504..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3504(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3504..................... starting Close3504\n");
	fprintf(fp, "Cor3504..................... starting Close3504\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3504..................... exiting Close3504 ERROR:");
		printf("Cor3504..................... exiting Close3504 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3504..................... exiting Close3504 STATUS = 0\n\n");
	printf("Cor3504..................... exiting Close3504 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3504........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3504........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3504(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3504( argc, argv, input[0], output[0], fp);
