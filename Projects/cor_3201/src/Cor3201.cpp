...
//
// INPUT 
//       3201.lv1       = grid event report
//
// OUTPUT 
//       3201.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3201(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3201......... starting  #########\n");
	fprintf(fp, "Cor3201..................... starting Open3201\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3201......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3201..................... starting Open3201\n");
	...
	if (pkttype!=32 || pktstype!=1) {
		printf("error packet type [32]   %d!!\n",pkttype );
	...
	if ( status) {
		fprintf(fp, "Cor3201..................... exiting Open3201 ERROR: %d", status);
		printf("Cor3201..................... exiting Open3201 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3201..................... exiting Open3201 STATUS = 0\n\n");
		printf("Cor3201..................... exiting Open3201 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3201..................... exiting CorrTime ERROR:");
		printf("Cor3201..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3201..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3201..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3201(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3201..................... starting Close3201\n");
	fprintf(fp, "Cor3201..................... starting Close3201\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3201..................... exiting Close3201 ERROR:");
		printf("Cor3201..................... exiting Close3201 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3201..................... exiting Close3201 STATUS = 0\n\n");
	printf("Cor3201..................... exiting Close3201 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3201........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3201........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3201(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3201( argc, argv, input[0], output[0], fp);
