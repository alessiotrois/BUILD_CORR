...
//
// INPUT 
//       3506.lv1       = grid event report
//
// OUTPUT 
//       3506.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3506(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3506......... starting  #########\n");
	fprintf(fp, "Cor3506..................... starting Open3506\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3506......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3506..................... starting Open3506\n");
	...
	if (pkttype!=35 || pktstype!=6) {
		printf("error packet type [35]   %d!!\n",pkttype );
		printf("error packet subtype [6] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3506..................... exiting Open3506 ERROR: %d", status);
		printf("Cor3506..................... exiting Open3506 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3506..................... exiting Open3506 STATUS = 0\n\n");
		printf("Cor3506..................... exiting Open3506 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3506..................... exiting CorrTime ERROR:");
		printf("Cor3506..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3506..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3506..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3506(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3506..................... starting Close3506\n");
	fprintf(fp, "Cor3506..................... starting Close3506\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3506..................... exiting Close3506 ERROR:");
		printf("Cor3506..................... exiting Close3506 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3506..................... exiting Close3506 STATUS = 0\n\n");
	printf("Cor3506..................... exiting Close3506 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3506........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3506........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3506(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3506( argc, argv, input[0], output[0], fp);
