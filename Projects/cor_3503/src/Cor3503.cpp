...
int Open3503(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3503......... starting  #########\n");
	fprintf(fp, "Cor3503..................... starting Open3503\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3503......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3503..................... starting Open3503\n");
	...
	if ( status) {
		fprintf(fp, "Cor3503..................... exiting Open3503 ERROR: %d", status);
		printf("Cor3503..................... exiting Open3503 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3503..................... exiting Open3503 STATUS = 0\n\n");
		printf("Cor3503..................... exiting Open3503 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3503..................... exiting CorrTime ERROR:");
		printf("Cor3503..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3503..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3503..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3503(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3503..................... starting Close3503\n");
	fprintf(fp, "Cor3503..................... starting Close3503\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3503..................... exiting Close3503 ERROR:");
		printf("Cor3503..................... exiting Close3503 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3503..................... exiting Close3503 STATUS = 0\n\n");
	printf("Cor3503..................... exiting Close3503 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3503........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3503........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3503(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3503( argc, argv, input[0], output[0], fp);
