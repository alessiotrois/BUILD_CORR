...
int Open3903(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3903......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3903..................... starting Open3903\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3903......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3903..................... starting Open3903\n");
	...
	if (pkttype!=39 || pktstype!=3) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [3] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3903..................... exiting Open3903 input ERROR:");
		printf("Cor3903..................... exiting Open3903 input ERROR:");		
		...
		fprintf(fp, "Cor3903..................... exiting Open3903\n");
		printf("Cor3903..................... exiting Open3903\n");		
...
///////////////////////////////////////////////////////////////////////////////////////////////		
	...
	if ( status) {
		fprintf(fp, "Cor3903..................... exiting CorrTime ERROR:");
		printf("Cor3903..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3903..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3903..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3903(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3903..................... starting Close3903\n");
	fprintf(fp, "Cor3903..................... starting Close3903\n");
	...
	if ( status) {
		fprintf(fp, "Cor3903..................... exiting Close3903 ERROR:");
		printf("Cor3903..................... exiting Close3903 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3903..................... exiting Close3903 STATUS = 0\n\n");
	printf("Cor3903..................... exiting Close3903 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3903......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3903......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3903(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3903( argc, argv, input[0], output[0], fp);
