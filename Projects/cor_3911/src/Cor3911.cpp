...
//
// INPUT 
//       3911.lv1       = grid event report
//
// OUTPUT 
//       3911.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3911(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp);
int WriteHeader(fitsfile * output);
int Close3911(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp);
...
int Open3911(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3911......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3911..................... starting Open3911\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3911......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3911..................... starting Open3911\n");
	...
	if (pkttype!=39 || pktstype!=11) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [11] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3911..................... exiting Open3911 input ERROR:");
		printf("Cor3911..................... exiting Open3911 input ERROR:");		
		...
		fprintf(fp, "Cor3911..................... exiting Open3911\n");
		printf("Cor3911..................... exiting Open3911\n");		
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	status = CorrTimePKT3911(output, fp);
...
/////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3911..................... exiting CorrTime ERROR:");
		printf("Cor3911..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3911..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3911..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3911(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3911..................... starting Close3911\n");
	fprintf(fp, "Cor3911..................... starting Close3911\n");
	...
	if ( status) {
		fprintf(fp, "Cor3911..................... exiting Close3911 ERROR:");
		printf("Cor3911..................... exiting Close3911 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3911..................... exiting Close3911 STATUS = 0\n\n");
	printf("Cor3911..................... exiting Close3911 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3911......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3911......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3911(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3911( argc, argv, input[0], output[0], fp);
