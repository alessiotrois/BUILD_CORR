...
int Open3401(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3401......... starting  #########\n");
	fprintf(fp, "Cor3401..................... starting Open3401\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3401......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3401..................... starting Open3401\n");
	...
	if (pkttype!=34 || pktstype!=1) {
		printf("error packet type [34]   %d!!\n",pkttype );
	...
	if ( status) {
		fprintf(fp, "Cor3401..................... exiting Open3401 ERROR: %d", status);
		printf("Cor3401..................... exiting Open3401 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3401..................... exiting Open3401 STATUS = 0\n\n");
		printf("Cor3401..................... exiting Open3401 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3401..................... exiting CorrTime ERROR:");
		printf("Cor3401..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3401..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3401..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3401(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3401..................... starting Close3401\n");
	fprintf(fp, "Cor3401..................... starting Close3401\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3401..................... exiting Close3401 ERROR:");
		printf("Cor3401..................... exiting Close3401 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3401..................... exiting Close3401 STATUS = 0\n\n");
	printf("Cor3401..................... exiting Close3401 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3401........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3401........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3401(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3401( argc, argv, input[0], output[0], fp);
