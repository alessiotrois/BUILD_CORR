...
//
// INPUT 
//       3913.lv1       = grid event report
//
// OUTPUT 
//       3913.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3913(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3913......... starting  #########\n");
	fprintf(fp, "Cor3913..................... starting Open3913\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3913......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3913..................... starting Open3913\n");
	...
	if (pkttype!=39 || pktstype!=13) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [13] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3913..................... exiting Open3913 ERROR: %d", status);
		printf("Cor3913..................... exiting Open3913 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3913..................... exiting Open3913 STATUS = 0\n\n");
		printf("Cor3913..................... exiting Open3913 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3913..................... exiting CorrTime ERROR:");
		printf("Cor3913..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3913..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3913..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3913(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3913..................... starting Close3913\n");
	fprintf(fp, "Cor3913..................... starting Close3913\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3913..................... exiting Close3913 ERROR:");
		printf("Cor3913..................... exiting Close3913 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3913..................... exiting Close3913 STATUS = 0\n\n");
	printf("Cor3913..................... exiting Close3913 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3913........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3913........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3913(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3913( argc, argv, input[0], output[0], fp);
