...
//
// INPUT 
//       3917.lv1       = grid event report
//
// OUTPUT 
//       3917.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3917(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp);
int WriteHeader(fitsfile * output);
int Close3917(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp);
...
int Open3917(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3917......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3917..................... starting Open3917\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3917......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3917..................... starting Open3917\n");
	...
	if (pkttype!=39 || pktstype!=17) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [17] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3917..................... exiting Open3917 input ERROR:");
		printf("Cor3917..................... exiting Open3917 input ERROR:");		
		...
		fprintf(fp, "Cor3917..................... exiting Open3917\n");
		printf("Cor3917..................... exiting Open3917\n");		
...
/////////////////////////////////////////////////////////////////////////////////////		
	...
	if ( status) {
		fprintf(fp, "Cor3917..................... exiting CorrTime ERROR:");
		printf("Cor3917..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3917..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3917..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3917(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3917..................... starting Close3917\n");
	fprintf(fp, "Cor3917..................... starting Close3917\n");
	...
	if ( status) {
		fprintf(fp, "Cor3917..................... exiting Close3917 ERROR:");
		printf("Cor3917..................... exiting Close3917 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3917..................... exiting Close3917 STATUS = 0\n\n");
	printf("Cor3917..................... exiting Close3917 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3917......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3917......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3917(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3917( argc, argv, input[0], output[0], fp);
