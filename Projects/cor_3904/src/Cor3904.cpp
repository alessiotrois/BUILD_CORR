...
//
// INPUT 
//       3904.lv1       = grid event report
//
// OUTPUT 
//       3904.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3904(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3904......... starting  #########\n");
	fprintf(fp, "Cor3904..................... starting Open3904\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3904......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3904..................... starting Open3904\n");
	...
	if (pkttype!=39 || pktstype!=4) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [4] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3904..................... exiting Open3904 ERROR: %d", status);
		printf("Cor3904..................... exiting Open3904 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3904..................... exiting Open3904 STATUS = 0\n\n");
		printf("Cor3904..................... exiting Open3904 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3904..................... exiting CorrTime ERROR:");
		printf("Cor3904..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3904..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3904..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3904(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3904..................... starting Close3904\n");
	fprintf(fp, "Cor3904..................... starting Close3904\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3904..................... exiting Close3904 ERROR:");
		printf("Cor3904..................... exiting Close3904 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3904..................... exiting Close3904 STATUS = 0\n\n");
	printf("Cor3904..................... exiting Close3904 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3904........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3904........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3904(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3904( argc, argv, input[0], output[0], fp);
