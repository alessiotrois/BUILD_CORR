...
//
// INPUT 
//       3601.lv1       = grid event report
//
// OUTPUT 
//       3601.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3601(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3601......... starting  #########\n");
	fprintf(fp, "Cor3601..................... starting Open3601\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3601......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3601..................... starting Open3601\n");
	...
	if (pkttype!=36 || pktstype!=1) {
		printf("error packet type [36]   %d!!\n",pkttype );
	...
	if ( status) {
		fprintf(fp, "Cor3601..................... exiting Open3601 ERROR: %d", status);
		printf("Cor3601..................... exiting Open3601 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3601..................... exiting Open3601 STATUS = 0\n\n");
		printf("Cor3601..................... exiting Open3601 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3601..................... exiting CorrTime ERROR:");
		printf("Cor3601..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3601..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3601..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3601(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3601..................... starting Close3601\n");
	fprintf(fp, "Cor3601..................... starting Close3601\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3601..................... exiting Close3601 ERROR:");
		printf("Cor3601..................... exiting Close3601 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3601..................... exiting Close3601 STATUS = 0\n\n");
	printf("Cor3601..................... exiting Close3601 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3601........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3601........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3601(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3601( argc, argv, input[0], output[0], fp);
