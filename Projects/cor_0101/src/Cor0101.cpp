...
//
// INPUT 
//       0101.lv1       = grid event report
//
// OUTPUT 
//       0101.cor       = grid event report
//
//
// FILE HISTORY
...
int Open0101(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor0101......... starting  #########\n");
	fprintf(fp, "Cor0101..................... starting Open0101\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor0101......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor0101..................... starting Open0101\n");
	...
	if ( status) {
		fprintf(fp, "Cor0101..................... exiting Open0101 ERROR: %d", status);
		printf("Cor0101..................... exiting Open0101 ERROR: %d", status);		
		...
		fprintf(fp, "Cor0101..................... exiting Open0101 STATUS = 0\n\n");
		printf("Cor0101..................... exiting Open0101 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor0101..................... exiting CorrTime ERROR:");
		printf("Cor0101..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor0101..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor0101..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close0101(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor0101..................... starting Close0101\n");
	fprintf(fp, "Cor0101..................... starting Close0101\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor0101..................... exiting Close0101 ERROR:");
		printf("Cor0101..................... exiting Close0101 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor0101..................... exiting Close0101 STATUS = 0\n\n");
	printf("Cor0101..................... exiting Close0101 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor0101........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor0101........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open0101(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close0101( argc, argv, input[0], output[0], fp);
