...
//
// INPUT 
//       3910.lv1       = grid event report
//
// OUTPUT 
//       3910.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3910(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp);
int WriteHeader(fitsfile * output);
int Close3910(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp);
...
int Open3910(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3910......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3910..................... starting Open3910\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3910......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3910..................... starting Open3910\n");
	...
	if (pkttype!=39 || pktstype!=10) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [10] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3910..................... exiting Open3910 input ERROR:");
		printf("Cor3910..................... exiting Open3910 input ERROR:");		
		...
		fprintf(fp, "Cor3910..................... exiting Open3910\n");
		printf("Cor3910..................... exiting Open3910\n");		
...
/////////////////////////////////////////////////////////////////////////////////////		
	...
	if ( status) {
		fprintf(fp, "Cor3910..................... exiting CorrTime ERROR:");
		printf("Cor3910..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3910..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3910..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3910(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3910..................... starting Close3910\n");
	fprintf(fp, "Cor3910..................... starting Close3910\n");
	...
	if ( status) {
		fprintf(fp, "Cor3910..................... exiting Close3910 ERROR:");
		printf("Cor3910..................... exiting Close3910 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3910..................... exiting Close3910 STATUS = 0\n\n");
	printf("Cor3910..................... exiting Close3910 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3910......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3910......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3910(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3910( argc, argv, input[0], output[0], fp);
