...
//
// INPUT 
//       3918.lv1       = grid event report
//
// OUTPUT 
//       3918.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3918(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3918......... starting  #########\n");
	fprintf(fp, "Cor3918..................... starting Open3918\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3918......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3918..................... starting Open3918\n");
	...
	if (pkttype!=39 || pktstype!=18) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [18] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3918..................... exiting Open3918 ERROR: %d", status);
		printf("Cor3918..................... exiting Open3918 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3918..................... exiting Open3918 STATUS = 0\n\n");
		printf("Cor3918..................... exiting Open3918 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3918..................... exiting CorrTime ERROR:");
		printf("Cor3918..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3918..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3918..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3918(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3918..................... starting Close3918\n");
	fprintf(fp, "Cor3918..................... starting Close3918\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3918..................... exiting Close3918 ERROR:");
		printf("Cor3918..................... exiting Close3918 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3918..................... exiting Close3918 STATUS = 0\n\n");
	printf("Cor3918..................... exiting Close3918 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3918........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3918........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3918(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3918( argc, argv, input[0], output[0], fp);
