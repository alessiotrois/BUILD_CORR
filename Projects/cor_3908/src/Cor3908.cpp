...
//
// INPUT 
//       3908.lv1       = grid event report
//
// OUTPUT 
//       3908.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3908(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp);
int WriteHeader(fitsfile * output);
int Close3908(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp);
...
int Open3908(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3908......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3908..................... starting Open3908\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3908......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3908..................... starting Open3908\n");
	...
	if (pkttype!=39 || pktstype!=8) {
		...
		printf("error packet subtype [8] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3908..................... exiting Open3908 input ERROR:");
		printf("Cor3908..................... exiting Open3908 input ERROR:");		
		...
		fprintf(fp, "Cor3908..................... exiting Open3908\n");
		printf("Cor3908..................... exiting Open3908\n");		
...
/////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3908..................... exiting CorrTime ERROR:");
		printf("Cor3908..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3908..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3908..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3908(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3908..................... starting Close3908\n");
	fprintf(fp, "Cor3908..................... starting Close3908\n");
	...
	if ( status) {
		fprintf(fp, "Cor3908..................... exiting Close3908 ERROR:");
		printf("Cor3908..................... exiting Close3908 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3908..................... exiting Close3908 STATUS = 0\n\n");
	printf("Cor3908..................... exiting Close3908 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3908......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3908......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3908(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3908( argc, argv, input[0], output[0], fp);
