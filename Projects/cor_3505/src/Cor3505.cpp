...
//
// INPUT 
//       3505.lv1       = grid event report
//
// OUTPUT 
//       3505.cor       = grid event report
//
//
// FILE HISTORY
...
int Open3505(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "####################################################\n");
	fprintf(fp, "#########  Task Cor3505......... starting  #########\n");
	fprintf(fp, "Cor3505..................... starting Open3505\n");

	
	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3505......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3505..................... starting Open3505\n");
	...
	if ( status) {
		fprintf(fp, "Cor3505..................... exiting Open3505 ERROR: %d", status);
		printf("Cor3505..................... exiting Open3505 ERROR: %d", status);		
		...
		fprintf(fp, "Cor3505..................... exiting Open3505 STATUS = 0\n\n");
		printf("Cor3505..................... exiting Open3505 STATUS = 0\n\n");		
		}
	return status;	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if ( status) {
		fprintf(fp, "Cor3505..................... exiting CorrTime ERROR:");
		printf("Cor3505..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;		
		...
		fprintf(fp, "Cor3505..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3505..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3505(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {

	printf("Cor3505..................... starting Close3505\n");
	fprintf(fp, "Cor3505..................... starting Close3505\n");
	int status = 0;
	int hdnum = 0;
	...
	if ( status) {
		fprintf(fp, "Cor3505..................... exiting Close3505 ERROR:");
		printf("Cor3505..................... exiting Close3505 ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;			
	...
	fprintf(fp, "Cor3505..................... exiting Close3505 STATUS = 0\n\n");
	printf("Cor3505..................... exiting Close3505 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3505........... exiting #########\n");
	printf("####################################################\n\n\n");	
	
		
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3505........... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");			
...
FILE *fp;
fp = fopen("/dev/null", "w");
status = Open3505(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3505( argc, argv, input[0], output[0], fp);
