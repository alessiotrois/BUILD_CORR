...
int Open3902(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp);
int CorrAtt(fitsfile * input, fitsfile * output, FILE *fp);
int WriteHeader(fitsfile * output);
int Close3902(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp);
...
int Open3902(int argc, char ** argv, fitsfile ** input, fitsfile ** output, FILE *fp) {
	...
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3902......... starting  #########\n");
	fprintf(fp, "####################################################\n\n\n");
	fprintf(fp, "Cor3902..................... starting Open3902\n");

	printf("\n\nSTART EXECUTION:  %s",data);	
	printf("####################################################\n");
	printf("#########  Task Cor3902......... starting  #########\n");
	printf("#########         %s         #########\n", version);
	printf("####################################################\n\n\n");
	printf("Cor3902..................... starting Open3902\n");
	...
	if (pkttype!=39 || pktstype!=2) {
		printf("error packet type [39]   %d!!\n",pkttype );
		printf("error packet subtype [2] %d!!\n",pktstype );
	...
	if ( status) {
		fprintf(fp, "Cor3902..................... exiting Open3902 input ERROR:");
		printf("Cor3902..................... exiting Open3902 input ERROR:");		
		...
		fprintf(fp, "Cor3902..................... exiting Open3902\n");
		printf("Cor3902..................... exiting Open3902\n");		
...
///////////////////////////////////////////////////////////////////////////////////////////////		
	...
	if ( status) {
		fprintf(fp, "Cor3902..................... exiting CorrTime ERROR:");
		printf("Cor3902..................... exiting CorrTime ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);
		printf("\n");
		return status;			
		...
		fprintf(fp, "Cor3902..................... exiting CorrTime STATUS = 0\n\n");
		printf("Cor3902..................... exiting CorrTime STATUS = 0\n\n");		
		}
...
int Close3902(int argc, char ** argv, fitsfile * input, fitsfile * output, FILE *fp) {
	...
	printf("Cor3902..................... starting Close3902\n");
	fprintf(fp, "Cor3902..................... starting Close3902\n");
	...
	if ( status) {
		fprintf(fp, "Cor3902..................... exiting Close3902 ERROR:");
		printf("Cor3902..................... exiting Close3902 input ERROR:");		
		fits_report_error(fp, status);
		fits_report_error(stdout, status);	
		printf("\n");
		return status;
	...
	fprintf(fp, "Cor3902..................... exiting Close3902 STATUS = 0\n\n");
	printf("Cor3902..................... exiting Close3902 STATUS = 0\n\n");		
	...
	printf("\n\n####################################################\n");
	printf("#########  Task Cor3902......... exiting #########\n");
	printf("####################################################\n\n\n");					
	fprintf(fp, "\n\n####################################################\n");
	fprintf(fp, "#########  Task Cor3902......... exiting #########\n");
	fprintf(fp, "####################################################\n\n\n");		
...
FILE *fp;
fp = fopen("/dev/null", "a+");
status = Open3902(argc, argv, input, output, fp);
...
if (status ==0)	
	status = Close3902( argc, argv, input[0], output[0], fp);
